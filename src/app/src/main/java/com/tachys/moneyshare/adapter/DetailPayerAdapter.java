 ...
 */
public class DetailPayerAdapter extends BaseAdapter {
    ...
    public DetailPayerAdapter(Context context, List<Payer> items) {
        mContext = context;
        list = items;
    }
    ...
    @Override
    public Payer getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.amt.setText(String.valueOf(getItem(position).amountPaid));
        return convertView;
    }
}
